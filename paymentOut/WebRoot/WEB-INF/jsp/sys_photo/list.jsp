...
<script type="text/javascript">
	rwpTemp.businessconfigstrbaritems = {
		items : [ {
			...
			url : '${ctx}/spcConfigController/addMacPhoto?deptId=${deptId}'
		}, {
			text : '修改',
			click : rwpListLayout.gridToolButtonClick.itemclick,
			icon : 'edit',
			...
			url : '${ctx}/spcConfigController/editMacPhoto'
		}, {
			text : '删除',
			click : rwpListLayout.gridToolButtonClick.itemclick,
			icon : 'delete',
			...
			confirm : true,
			postajax : true,
			url : '${ctx}/spcConfigController/deleteById'
		}]
	};
	$(function() {
				...
				.rwpUIDatagrid(
						{
							...
							url : '${ctx}/spcConfigController/photoListOfMacJson?1=1',
							height : '99%',
	...
	$(function() {
		$(".pageHeader").html("<i class='i'></i>宣传图片系统配置");
