...
<script type="text/javascript">
	rwpTemp.f_selectphotoName = function() {
		var url = '${ctx}/macPhotoController/sampleDialog?type=1' + '&rnd='
				+ Math.random();
...
<form action="${ctx}/spcConfigController/saveMacPhoto" id="ajaxform"
	method="post">
	<fieldset>
		<legend>
			<i class="i"></i>图片信息
		...
		<input id="id" name="id" type="hidden" value="${maConfig.id}" /> <input
			id="relationId" name="relationId" type="hidden" value="0" />
		<div class="formpanel">
			<div class="clear">
				...
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="ckbh">当前系统</label></li>
					<li class="editor-field"><input data-val="true"
						readonly="readonly" type="text" value="${sysBaseInfo.sysName}" /></li>
					<li class="editor-validation"><span
