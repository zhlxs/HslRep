...
<div class="weui-msg" style="background: url('${pageContext.request.contextPath }/wx/img/background.jpg');background-size: 100% auto;height: 155px;padding-top: 45px">
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a id="order" href="javascript:;" class="weui-btn weui-btn_primary">预约申请</a>
            <a id="search" href="javascript:;" class="weui-btn weui-btn_primary">预约查询与取消</a>
        </p>
    </div>
...
<script type="text/javascript">
    $("#order").click(function () {
        ...
        window.location.href = '${pageContext.request.contextPath }/appointmeAction/startappointme'
    });
    $("#search").click(function () {
        $("#loadingToast").css("display","block");
        window.location.href = '${pageContext.request.contextPath }/appointmeAction/queryAppointmeInfo'
    });
</script>
</html>
