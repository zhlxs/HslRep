...
<div class="weui-msg" style="background: url('${pageContext.request.contextPath }/wx/img/background.jpg');background-size: 100% auto;height: 155px;padding-top: 45px">
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            ...
            <a id="order" href="javascript:;" class="weui-btn weui-btn_primary">预约签到</a>
            <c:if test="${sessionScope.openid==null}">
                <a id="search" href="javascript:;" class="weui-btn weui-btn_primary">现场取号</a>
            </c:if>
            <c:if test="${sessionScope.openid!=null}">
                <a id="start" href="${pageContext.request.contextPath }/squenceInfoAction/getcommSquenceJsp"
                   class="weui-btn weui-btn_primary">现场取号</a>
            </c:if>
...
<script type="text/javascript">
    $("#order").click(function () {
        ...
        window.location.href = '${pageContext.request.contextPath }/squenceInfoAction/hadAppointme'
    });
    $("#search").click(function () {
        $("#loadingToast").css("display","block");
        window.location.href = '${pageContext.request.contextPath }/wxAction/getCode?redirect_uri=squenceInfoAction/getcommSquenceJsp'
    });
</script>
</html>
