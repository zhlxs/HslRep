...
<script type="text/javascript">
	...
	$(function() {
		if ($("#deptId").val() != null && $("#deptId").val() != "") {
			$("#img_info").attr(
					'src',
					'${ctx}/deptaddressController/getIcon?id='
							+ $("#deptId").val() + '&rnd' + Math.random());
		}
		...
		$("#ajaxform").rwpUIForm({
			...
			ajaxSubmitAttrs : {
				beforeSubmit : function() {
					var option = {
						url : '${ctx}/deptaddressController/saveAddress',
						type : 'POST',
						// async: false,
						dataType : 'json',
...
<form action="" id="ajaxform"
	...
	<fieldset>
		<legend>
			<i class="i"></i>新增办证网点信息
		</legend>
		<div class="formpanel">
			<input data-val="true" data-val-number="字段ID必须是一个数字" id="id" name="id" type="hidden"
				value="${address.id}" />
			<input data-val="true" data-val-number="字段deptId必须是一个数字" id="deptId" name="deptId" type="hidden"
				value="${address.deptId}" />
			<div class="clear">
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="file1">公众号二维码</label></li>
			...
			<div class="clear">
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="longitude">经度</label></li>
					<li class="editor-field"><input data-val="true"
						style="width: 150px;" maxlength="32" data-val-length="经度不能超过50字符"
						data-val-length-max="50" data-val-required="经度不能为空" id="longitude"
						name="longitude" type="text" value="${address.longitude}" /></li>
					<li class="editor-validation"><span
						class="field-validation-valid" data-valmsg-for="longitude"
						data-valmsg-replace="true"></span></li>
				</ul>
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="latitude">纬度</label></li>
					<li class="editor-field"><input data-val="true"
						style="width: 150px;" maxlength="32" data-val-length="纬度不能超过50字符"
						data-val-length-max="50" data-val-required="纬度不能为空" id="latitude"
						name="latitude" type="text" value="${address.latitude}" /></li>
					<li class="editor-validation"><span
						class="field-validation-valid" data-valmsg-for="longitude"
						data-valmsg-replace="true"></span></li>
				</ul>
			...
			<div class="clear">
				<ul class="DialabelWidth">
					...
					<li style="display: none;"><input data-val="true"
						...
						type="hidden" value="${address.deptId}" /></li>
					<li class="editor-field"><input id="deptName" name="deptName"
						type="text" value="${address.dept.deptName}" /></li>
					<li class="editor-validation"><span
				...
				<ul class="DialabelWidth">
					...
					<li class="editor-field"><input data-val="true" class="ableacceptcount"
						style="width: 120px;" data-val-length="取号数不能超过2字符"
						data-val-length-max="50" data-val-required="取号数不能为空" id="ableacceptcount"
						name="ableacceptcount" type="text" value="${address.ableacceptcount}" /></li>
					<li class="editor-validation"><span
