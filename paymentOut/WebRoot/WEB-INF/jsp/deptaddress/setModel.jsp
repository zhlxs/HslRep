...
<form action="${ctx}/deptaddressController/saveModelsetting"
	id="ajaxform" method="post">
	<fieldset>
		<legend>
			<i class="i"></i>部门评价模板设置
		</legend>
		<div class="formpanel">
			...
			<div class="clear">
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="modelId">选择评价模板</label></li>
					<li style="display: none;"><input data-val="true"
						data-val-number="评价模板字段必须是一个数字" data-val-regex="请选择评价模板"
						data-val-regex-pattern="^[1-9]\d*|0$"
						data-val-required="评价模板字段是必需的。" id="modelId" name="modelId"
						type="hidden" value="${address.modelId}" /></li>
					<li class="editor-field"><input id="modelName" name="modelname"
						type="text" value="${address.model.modelname}" /></li>
