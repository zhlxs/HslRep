...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/css/pickout.css">
    <link rel="stylesheet" href="${ctx}/css/css/animate.css">
...
<div id="list" class="pk-modal -clean -show hide" style="overflow: scroll;height: 350px;width: 90%;left: 5%;right: 5%">
    ...
    <p style="color: red;text-align: center" id="state">您当前排在第<span id="person"></span>位</p>
                ...
                success:function (data) {
                    if(data.stateType == 0){
                        ...
                        $.each(data.stateValue,function (ind,val) {
                            ...
                            if(val.state == 0){
                                $("#lineList").append(
                                    "<li id='theCard"+ind+"' class='pk-option -clean' card='"+val.cardNumber+"'>"+
