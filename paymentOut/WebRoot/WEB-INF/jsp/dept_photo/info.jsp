...
<script type="text/javascript">
	rwpTemp.f_selectphotoName = function() {
		var url = '${ctx}/macPhotoController/sampleDialog?type=2' + '&rnd='
				+ Math.random();
...
<form action="${ctx}/dpcConfigController/saveMacPhoto" id="ajaxform"
	method="post">
	<fieldset>
		<legend>
			<i class="i"></i>图片信息
		...
		<input id="id" name="id" type="hidden" value="${maConfig.id}" /> <input
			id="relationId" name="relationId" type="hidden" value="${deptId}" />
		<div class="formpanel">
			<div class="clear">
				...
				<ul class="DialabelWidth">
					<li class="editor-label"><label for="ckbh">所属部门</label></li>
					<li class="editor-field"><input data-val="true"
						readonly="readonly" type="text" value="${macWindows.deptName}" /></li>
					<li class="editor-validation"><span
