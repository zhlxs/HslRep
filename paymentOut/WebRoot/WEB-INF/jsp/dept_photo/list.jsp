		...
		items : [
				{
					...
					url : '${ctx}/dpcConfigController/addMacPhoto?deptId=${deptId}'
				},
				{
					text : '修改',
					click : rwpListLayout.gridToolButtonClick.itemclick,
					...
					url : '${ctx}/dpcConfigController/editMacPhoto'
				}, {
					text : '删除',
					click : rwpListLayout.gridToolButtonClick.itemclick,
					icon : 'delete',
					...
					confirm : true,
					postajax : true,
					url : '${ctx}/dpcConfigController/deleteById'
				}, {
					text : '返回上一页',
					click : rwpListLayout.gridToolButtonClick.itemclick,
					icon : 'add',
					...
					max : 10000,
					link : true,
					url : '${ctx}/deptController/deptList'
				} ]
	};
	$(function() {
				...
				.rwpUIDatagrid(
						{
							...
							url : '${ctx}/dpcConfigController/photoListOfMacJson?deptId=${deptId}',
							height : '99%',
