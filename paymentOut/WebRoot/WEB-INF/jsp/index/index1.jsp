...
//                console.log(jump);
                    url = '"${ctx}/wx/businessAction/toApplybusiness?serCode='+childId+ '&businessType=' + businessType +'"';
                    ...
                    $ul.append(
                            ...
                            "<ul class='clearfix'>"+
                            "<li class='busi_cell'>"+
                            "<a isproxy='"+obj['isproxy']+"' id='jump"+index+"' href='javascript:void(0);' onclick='go(this)'>"+
                            "<img src="+str+">"+
                            "</a>"+
                            "</li>"+
                            "<li class='busi_cell'>"+
...
//                            "</li>"+
                            "<li>"+
                            "<span class='bs_info' id='b_info"+index+"'>" + child['serName'] + "</span>"+
                            "</li>"+
                            "</ul>"+
                            "</li>"+
                            "</ul>"+
