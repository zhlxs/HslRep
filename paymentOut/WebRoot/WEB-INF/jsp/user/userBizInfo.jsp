...
<script type="text/javascript">
    rwpTemp.userServicebaritems = {
        items: [{
            ...
            link: true,
            url: '${ctx}/userServiceController/addUserService?uiCode=${uiCode}'
        }
        ]
    };
            ...
            .rwpUIDatagrid(
                {
                    columns: [
...

                        {
                            ...
                            render: function (rowdata) {
                                ...
                                html += '<a href="${ctx}/userServiceController/deleteUserService?usCode='
                                    + rowdata.usCode
                    ...
                    usePager: false,
                    checkbox: false,
                    url: '${ctx}/userController/userBizInfoJson?uiCode=${uiCode}',
                    height: '99%',
