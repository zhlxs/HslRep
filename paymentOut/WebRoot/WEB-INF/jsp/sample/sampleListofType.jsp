...
<script type="text/javascript">
 rwpTemp.deptbaritems = {
		items : [ {
			...
			max : 10000,
			link : true,
			url : '${ctx}/businessconfigStuController/businessSruffList?applytypeid=${applytypeid}&serCode=${serCode}'
		}]
	}; 
				...
				.rwpUIDatagrid(
						{
							...
							url : '${ctx}/photoSampleController/sampleJsonofType?id=${id}',
							height : '99%',
...
<!-- <div class="searchBar">
	<form id="deptform">
		<dl style="width:286px;">
			<dt class="labelWidth" style="width:75px;">样图中文名称：</dt>
			<dd class="inputWidth">
