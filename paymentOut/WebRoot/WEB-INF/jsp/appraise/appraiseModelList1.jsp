...
<script type="text/javascript">
    rwpTemp.apprModelbaritems = {
        items: [{
            ...
            link : true,
            url: '${ctx}/appraiseContrller/addApprModel1'
        }, {
            text: '修改',
            click: rwpListLayout.gridToolButtonClick.itemclick,
            icon: 'edit',
            ...
            url: '${ctx}/appraiseContrller/editApprModel1'
        },
            {
                text: '删除',
                click: rwpListLayout.gridToolButtonClick.itemclick,
    ...
    rwpTemp.apprModellistiniturl = '${ctx}/appraiseContrller/apprModeleJson1?1=1'; //初始url
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (rowdata) {
                    var html = '<a href="${ctx}/appraiseContrller/modelDetails1?id=' + rowdata.id + '" rwpOpts="{ ispage: true }">查看详情'
                        + '</a>';
                    return html;
                },
                width: 180
