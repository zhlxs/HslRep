...
<article class="r-m301" style="background: #FEFCED;">
    ...
    <!--<div class="weui-cells" style="overflow: visible;margin-top: 0">-->
        <!--<div class="weui-cell" style="color: #919191;font-size: 14px">-->
            <!--<span style="padding: 5px 3px;">办理所需材料</span>-->
        <!--</div>-->

        <!-- <div class="weui-cell">
            <div class="weui-cell__hd">
                <label class="weui-label">身份证原件</label>
            </div>
            <div class="weui-cell__bd">
                <img class="example" src="img/example2.jpg" alt="">
            </div>
            <div class="weui-cell__ft">
                <span onclick='getphotostr(this)' class="check">点击查看</span>
            </div>
        </div> -->
        <!-- <div class="weui-cell">
            <div class="weui-cell__hd">
                <label class="weui-label">驾驶证原件</label>
            </div>
            <div class="weui-cell__bd">
                <img class="example" src="img/example1.jpg" alt="">
            </div>
            <div class="weui-cell__ft">
                <span onclick='getphotostr(this)' class="check">点击查看</span>
            </div>
    ...
    function judgeWeek() {
        ...
        if (value == "") {
            ...
            if (week == "7" || week == "6"){
            	...
            	//ajax方式加载预约时间段信息
            	var ajaxData = 'deptid=' + departmentId + '&businessType=${businessType}';
            	ajaxData += '&day=' + value;
            	$.ajax({
            		type : 'POST',
                ...
                if (isCardNo($("#useridcard").val()) == false) {
                	...
                	$.confirm({
                	    ...
                	    onOK:function () {
                            ...
                            ajaxData += '&businessType=${businessType}';
                            $.ajax({
                            	type:'POST',
                            		...
                            		if(data.stateType == 0){
                            			...
                            			$.alert({
                                      	  ...
                                      	  onOK: function () {
                                      	    //点击确认
                                      	    getHtml('${ctx}/wxUserAction/toIndex');
                                      	    //window.location.href = '${ctx}/wxUserAction/toIndex';
                                      	  }
                                      	});
                            		}
                            	}
