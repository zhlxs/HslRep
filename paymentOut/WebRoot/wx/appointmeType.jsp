    ...
    <div style="background: url('${pageContext.request.contextPath }/wx/img/background.jpg');background-size: 100% auto">
        <div style="height: 150px"></div>
            <div class="page__bd page__bd_spacing" style="margin-top: 50px;">
                <a  href="${pageContext.request.contextPath }/wxAction/getCode?deptid=47&redirect_uri=squenceInfoAction/getAppSquence&appid=wx6d4d594ef75edec4&secret=5827020e5fd8d8a037afb09232a29813" class="weui-btn weui-btn_primary art">本人预约</a>

                <a href="${pageContext.request.contextPath }/wx/otherSignin.jsp" class="weui-btn weui-btn_primary art">他人代约</a>
