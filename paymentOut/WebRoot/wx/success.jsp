...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area" style="text-align: center">
        ...
        <p class="weui-msg__desc">
            预约网点<span id="place" style="margin-left: 100px;">沙井派出所户政窗口</span>
        </p>
        <p class="weui-msg__desc">
            预约时间<span id="date" style="margin-left: 150px;">${appointmeInfo.appointmenttime}</span>
        </p>
        <p class="weui-msg__desc">
            预约时间段<span id="time" style="margin-left: 136px;">${appointmeInfo.timeQuan.time}</span>
        </p>
    </div>
    ...
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="${pageContext.request.contextPath }/wx/enter.jsp" class="weui-btn weui-btn_primary">确定</a>
        </p>
    </div>
